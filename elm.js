...
var author$project$Cognito$errors = _Platform_incomingPort('errors', elm$json$Json$Decode$string);
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Cognito$signupSuccess = _Platform_incomingPort(
	'signupSuccess',
	A2(
...
var author$project$Cognito$signup = _Platform_outgoingPort(
	'signup',
	function ($) {
			...
			switch (_n2.$) {
				case 'DoSignUp':
					return _Utils_Tuple2(
						model,
						author$project$Cognito$signup(
							{emailAddress: currentEmailAddress, password: currentPassword, username: currentUsername}));
...
var author$project$Main$DoSignUp = {$: 'DoSignUp'};
var author$project$Main$SetEmailAddress = function (a) {
	return {$: 'SetEmailAddress', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Welcome! Please sign up.')
						])),
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Main$SetEmailAddress)
						]),
					_List_Nil),
					A2(elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(author$project$Main$DoSignUp)
						]),
					_List_fromArray(
						[
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		...
		subscriptions: function (model) {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						author$project$Cognito$signupSuccess(author$project$Main$CognitoSignupSuccess),
						author$project$Cognito$errors(author$project$Main$CognitoError)
					]));
		},
